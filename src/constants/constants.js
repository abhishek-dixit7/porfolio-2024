export const twitterUrl = 'https://twitter.com/_blunder0_0';
export const linkedinUrl =
  'https://www.linkedin.com/in/abhishek-dixit-34b76a151/';
export const githubUrl = 'https://github.com/abhishek-dixit7';
